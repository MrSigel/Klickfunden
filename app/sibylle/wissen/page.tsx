    ...
    <main className="bg-cream px-4 py-16 text-warmBlack md:px-0 md:py-24">
      <div className="container space-y-10">
        <div className="space-y-4">
          <p className="text-sm font-semibold uppercase tracking-[0.32em] text-deepOlive">Wissen</p>
          <h1 className="text-3xl font-semibold sm:text-4xl md:text-5xl">Wissen über systemische Muster und Selbsterfahrung</h1>
          <p className="max-w-3xl text-base leading-8 text-deepOlive md:text-lg">
            Hier findest du Hintergründe zur Arbeit mit Systemaufstellungen, damit du verstehen kannst, wie Muster und Beziehungen in dir wirken.
          </p>
        </div>
