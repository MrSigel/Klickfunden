  ...
  return <section className="section-shell overflow-hidden">
    ...
    <div className="container relative grid gap-12 lg:grid-cols-[.55fr_1fr] lg:gap-20">
      ...
      <motion.div initial={{opacity:0,y:35}} whileInView={{opacity:1,y:0}} viewport={{once:true,amount:.25}} transition={{duration:.9}}>
        ...
        <div className="mt-10 grid gap-7 border-t border-olive/20 pt-8 md:grid-cols-2"><p className="text-base leading-8 text-deepOlive/85">Systemische Aufstellungen können Zusammenhänge in Beziehungen, Herkunft und dem eigenen Erleben sichtbar machen.</p><p className="text-base leading-8 text-deepOlive/85">Im Mittelpunkt stehen deine Wahrnehmung, deine Geschichte und die Frage, was für deinen nächsten Schritt stimmig ist.</p></div>
      </motion.div>
    </div>
  </section>;
}
